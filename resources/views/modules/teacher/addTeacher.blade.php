            ...
            <form action="{{URL::to('/storeTeacher')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card card-primary">
                    <div class="card-header" style="background-color: #ff9900;">
                        <h3 class="card-title text-white font-weight-bold">Add Teacher Profile</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="teacherPic">Upload Picture *</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="educQualification" id="educQualification"
