    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header" style="background-color: #ffc266;">
                        <h3 class="float-left pt-1 text-white font-weight-bold">Amount</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            @if( $credit > 0)
                            <div class="col-3">
                                <div class="small-box border border-warning text-warning p-2"
                                    style="border-radius: 7px">
                                    <h5 class="py-3 ml-2 font-weight-bold">Credit</h5>
                                    <h1 class="text-center py-2">{{ $credit }}</h1>
                                </div>
                                <a href="{{URL::to('/clearCredit/'.$billingStudent->studentId)}}"
                                    class="btn btn-success">Clear Credit</a>
                            </div>
                            @endif
                            <div class="col-3">
                                <div class="small-box border border-danger text-danger p-2" style="border-radius: 7px">
                                    <h5 class="py-3 ml-2 font-weight-bold">Pending</h5>
                                    <h1 class="text-center py-2">{{ $unpaid }}</h1>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="small-box border border-success text-success p-2"
                                    style="border-radius: 7px">
                                    <h5 class="py-3 ml-2 font-weight-bold">Paid</h5>
                                    <h1 class="text-center py-2">{{ $paid }}</h1>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="small-box border border-primary text-primary p-2"
                                    style="border-radius: 7px">
                                    <h5 class="py-3 ml-2 font-weight-bold">Total</h5>
            ...
            <section class="col-md-12">
                <div class="card">
                    <div class="card-header" style="background-color: #ffc266;">
                        <h3 class="float-left pt-1 text-white font-weight-bold">Schedule and Billing of
                            {{ ucfirst(trans($billingStudent->studentName)) }}</h3>
                        <button id="add-more" class="btn btn-success pt-1 float-right">Add More</button>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="studentName" value="{{ $billingStudent->studentName }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="classDate[]" inputmode="numeric"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="time" name="classTime[]" inputmode="numeric"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="payment[]" inputmode="numeric"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" name="teacherName[]"
                                                    data-placeholder="Select Teacher" style="width: 100%;">
                                                    <option disabled selected>Select Teacher</option>
                                                    @foreach( $allTeachers as $index => $teachers)
                                                    <option
                                                        value="{{ $teachers->teacherId }}|{{ $teachers->teacherName }}"
                                                        id="teacherName_{{ $index }}">{{ $teachers->teacherName }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" name="subject[]"
                                                    ata-placeholder="Select Teacher" style="width: 100%;">
                                                    <option disabled selected>Select Subject</option>
                                                    @foreach( $allSubjects as $index => $subject)
                                                    <option value="{{ ucfirst(trans($subject->subjectName)) }}"
                                                        id="subject_{{ $index }}">
                                                        {{ ucfirst(trans($subject->subjectName)) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="teacherPayment[]" inputmode="numeric"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="modeOfClass" name="modeOfClass[]"
                ...
                <div class="card">
                    ...
                    <div class="card-body recurringForm d-none">
                        <form action="{{ URL::to('/recurringClasses') }}" method="POST">
                            @csrf
                            <input type="hidden" name="studentId" value="{{ $billingStudent->studentId }}">
                            <input type="hidden" name="studentName" value="{{ $billingStudent->studentName }}"
                                class="form-control" readonly>
                            <div class="row mb-5">
                                <div class="col-2">
                                    <h4>Recurrence :</h4>
                                ...
                                <div class="col-10">
                                    <div class="form-group">
                                        <select id="recurrence" name="recurrence"
                                            class="form-control ml-5 col-4 custom-select">
                            ...
                            <div id="weekly" class="row d-none">
                                ...
                                <div class="col-10 d-flex justify-content-around align-items-center">
                                    ...
                                    'Sunday'] as $day)
                                    <div>
                                        <input type="checkbox" name="days[]" class="form-check-input" id="{{ $day }}"
                                            value="{{ $day }}">
                            ...
                            <div class="row my-5">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="classDateFrom" inputmode="numeric"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="classDateTill" inputmode="numeric"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" name="teacherName"
                                            ...
                                            <option disabled selected>Select Teacher</option>
                                            @foreach( $allTeachers as $index => $teachers)
                                            <option value="{{ $teachers->teacherId }}|{{ $teachers->teacherName }}"
                                                id="teacherName_{{ $index }}">{{ $teachers->teacherName }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" name="subject"
                                            ...
                                            @foreach( $allSubjects as $index => $subject)
                                            <option value="{{ ucfirst(trans($subject->subjectName)) }}"
                                                id="subject_{{ $index }}">{{ ucfirst(trans($subject->subjectName)) }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #ffc266;">
                        <h3 class="text-white pt-2">Payment History</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        @if( $billingRecords->count() > 0)
                            ...
                            <table class="table table-bordered history" style="width: 130vw;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            @if( $billingRecord->classStatus == 'active' && $billingRecord->status ==
                                            'pending')
                                            <span class="badge badge-danger badge-pill py-2 px-4">Pending</span>
                                            @elseif($billingRecord->classStatus == 'cancel')
                                            <span class="badge badge-danger badge-pill py-2 px-4">Cancelled</span>
                                            @else
                ...
                <div class="card">
                    <div class="card-header" style="background-color: #ffc266;">
                        <h3 class="float-left text-white pt-2">Class Schedule and History</h3>
                        @if ($billingRecords && isset($billingRecord->studentId) && $billingRecords->count() > 0)
                        <a href="{{ URL::to('/sendStudentSchedule/'.$billingRecord->studentId) }}" type="submit"
                            class="btn btn-success mt-2 float-right">
                            Send Schedule
                        </a>
                        @else
                        <a href="" type="submit" class="btn btn-success mt-2 float-right">
                            Send Schedule
                        </a>
                        @endif
                    </div>
                            ...
                            <table class="table table-bordered history" style="width: 130vw">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            @if( $billingRecord->classStatus == 'active' && $billingRecord->attendance
                                            ==
                                            'pending')
                                            <span class="badge badge-danger badge-pill py-2 px-4">Pending</span>
                                            @elseif($billingRecord->classStatus == 'cancel')
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <span class="badge badge-danger badge-pill py-2 px-4">Cancelled</span>
                                            @else
                                            <span class="badge badge-success badge-pill py-2 px-4">Active</span>
                                            @endif
                                        </td>
                                        @php
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <a href="{{ URL::to('/editBill/'.$billingRecord->id) }}" type="submit"
                                            ...
                                            <a href="#" class="btn btn-danger m-1" data-toggle="modal"
                                                data-target="#confirmDeleteModal" data-id="{{$billingRecord->id}}"
                                                data-url="{{URL::to('/deleteBill/')}}">Delete <i
